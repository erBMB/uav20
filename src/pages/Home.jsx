        ...
        <aside>
          ...
          <div className="dimText">
            <p>
              ...
              Facultatii de Inginerie din cadrul Universitatii "Aurel Vlaicu"
              din Arad, se afla la a XXII-a editie.{" "}
            </p>
            <p>
            ...
            <p>
              ...
              studentii din diversele centre universitare atat din tara cat si
              din afara tarii, de a schimba pareri, opinii, cunostinte, de a
              lega colaborari viitoare, prietenii si de a primii sfaturi de la
              cei mai buni în domeniu, doctoranzi, masteranzi si profesori din
              mediul academic de pe plan atat național cat si international.{" "}
            </p>
            <p>
              Diplomele care vor fi oferite participantilor, diplome de
              participare sau de premiere pentru cele mai bune lucrari, vor
              putea constitui un plus în CV-ul personal al studentului.
              Competitia intre studentii participanti la sesiunile de comunicari
              este benefica si poate constitui un mod de afirmare în evolutia
              profesionala a studentului.
            </p>
          </div>
        </aside>
      </div>
